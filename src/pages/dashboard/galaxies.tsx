    ...
    return <div className="flex flex-col mt-4">
        ...
        <div className="bg-gray-700 p-2 my-2 flex flex-row">
            <div className="flex flex-row mx-2">
                ...
                <h2 className="mr-2">propose to</h2>
                {
                ...
                }
                {
                    ...
                    <h2 className="bg-gray-600 ml-2 px-2">{proposalText || <div className="w-28"></div>}</h2>
                        <Link href="/dashboard/editProposal" className="px-2 underline">Propose</Link>
                    </div>
                }
            </div>
        </div>
        ...
        <div className="">
            <h2 className="text-xl px-2">History</h2>
            <div className="flex flex-col">
                {
                    galaxiesHistory.map((galaxy) => {
