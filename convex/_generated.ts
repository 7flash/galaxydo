...
import type apiSetupRooms from "./apiSetupRooms";
import type getConsensusNumber from "./getConsensusNumber";
import type getFractalRanking from "./getFractalRanking";
...
import type userSaveRoom from "./userSaveRoom";
import type userSaveVote from "./userSaveVote";
...
export type ConvexAPI = {
  queries: {
    getConsensusNumber: ClientQuery<typeof getConsensusNumber>;
    getFractalRanking: ClientQuery<typeof getFractalRanking>;
  ...
  mutations: {
    apiSetupRooms: ClientMutation<typeof apiSetupRooms>;
    userConfirmVote: ClientMutation<typeof userConfirmVote>;
    userSaveAccount: ClientMutation<typeof userSaveAccount>;
    userSaveRoom: ClientMutation<typeof userSaveRoom>;
    userSaveVote: ClientMutation<typeof userSaveVote>;
  };
};
